    ...
    return (
        <div className="app">
            ...
            <nav className="left-menu">
                <ul className="inbox-list">
                    <li
                        ...
                        onClick={() => {setCurrentTab("inbox"); setSingleEmailView(false)}}
                    >
                    ...
                    <li
                        ...
                        onClick={() => {setCurrentTab("starred"); setSingleEmailView(false)}}
                    >
            ...
            {singleEmailView && 
                ...
                setSingleEmailView={setSingleEmailView}
                />
            }
        </div>
    )
